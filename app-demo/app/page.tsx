        ...
        <div className="relative z-10 mx-auto grid min-h-[88svh] max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-[5fr_7fr]">
          <div className="animate-fade-up text-ivory">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <Link
                href="/dat-lich"
                className="btn-press flex items-center gap-2 rounded-sm bg-gold-500 px-[2.4rem] py-[1.2rem] text-[1.35rem] font-semibold text-wood-700 shadow-[var(--shadow-soft)] transition-colors hover:bg-gold-400"
              >
      ...
      <section className="mx-auto max-w-6xl px-4 pb-8 sm:px-6">
        <div className="cta-glow on-dark frame-gold px-6 py-16 text-center text-ivory sm:px-12">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/dat-lich"
              className="flex items-center gap-2 rounded-sm bg-gold-500 px-[2.4rem] py-[1.2rem] text-[1.35rem] font-semibold text-wood-700 shadow-[var(--shadow-soft)] transition-colors hover:bg-gold-400"
            >
              <CalendarPlus className="h-6 w-6" /> Đặt lịch ngay
            </Link>
            <a
