...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      "Thứ hai, cứ mỗi 45–60 phút hãy đứng dậy vận động nhẹ, xoay vai và kéo giãn cổ trong 1–2 phút. Đây là cách đơn giản nhất để khí huyết được khơi thông trở lại.",
  ...
  },
  {
    ...
    body: [
      ...
      "Ngâm chân thảo dược ấm trước khi ngủ giúp khí huyết dồn về phần dưới cơ thể, làm ấm bàn chân và tạo cảm giác thư giãn lan tỏa. Nhiều người chỉ cần 15–20 phút ngâm chân là đã thấy dễ ngủ hơn.",
