        ...
        >
          ...
          <div className="flex flex-col justify-center p-8 sm:p-10">
            <div className="flex items-center gap-3">
              <span className="rounded-sm bg-crimson-600 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-gold-200">
                {featured.cat}
              </span>
              <span className="text-sm font-semibold uppercase tracking-[0.15em] text-gold-700">
                Bài nổi bật
              </span>
            </div>
            <h2 className="mt-4 text-2xl leading-tight text-crimson-600 sm:text-3xl">
              {featured.title}
            </h2>
            ...
            <div className="mt-5 flex items-center gap-4 text-sm text-ink-mute">
              <span className="flex items-center gap-1.5">
                <CalendarDays className="h-4 w-4" /> {fmtDate(featured.date)}
              </span>
              <span className="flex items-center gap-1.5">
                <Clock className="h-4 w-4" /> {featured.readTime}
              </span>
            </div>
            <span className="mt-6 inline-flex items-center gap-1.5 text-base font-semibold uppercase tracking-wide text-crimson-600">
              Đọc bài viết{" "}
        ...
        {rest.map((post) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-7">
              ...
              <h3 className="mt-2 text-xl font-semibold leading-snug text-crimson-600 group-hover:text-crimson-700">
                {post.title}
              </h3>
              ...
              <div className="mt-4 flex items-center gap-4 text-sm text-ink-mute">
                <span className="flex items-center gap-1.5">
                  <CalendarDays className="h-4 w-4" /> {fmtDate(post.date)}
                </span>
                <span className="flex items-center gap-1.5">
