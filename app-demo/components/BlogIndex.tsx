        ...
        >
          ...
          <div className="flex flex-col justify-center p-8 sm:p-10">
            <div className="flex items-center gap-3">
              <span className="rounded-sm bg-crimson-600 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-gold-200">{featured.cat}</span>
              <span className="text-sm font-semibold uppercase tracking-[0.15em] text-gold-600">Bài nổi bật</span>
            </div>
        ...
        {rest.map((post) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-7">
              <span className="text-xs font-semibold uppercase tracking-[0.15em] text-gold-600">{post.cat}</span>
              <h3 className="mt-2 text-xl font-semibold leading-snug text-crimson-600 group-hover:text-crimson-700">{post.title}</h3>
