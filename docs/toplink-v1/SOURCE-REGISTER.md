...
| ------- | ------------------------------------------------------------ | ---------------------------- | --------------------------------- | -------------------------------------------------------- | ------------- | ---------------------------------------------------------------- |
| SRC-001 | Current user P3B execution prompt                            | execution authority          | highest for P3B                   | lock Direction C, compile authority, evidence and gate   | ACTIVE        | records human C selection; authorizes P3A → P3B only             |
...
| SRC-011 | `docs/toplink-v1/research/P1-DESIGN-INPUT-SYNTHESIS.md`      | approved P1 synthesis        | bounded design-input authority    | morphology, audience, trust and reference grammar        | REFERENCE     | `REFERENCE GRAMMAR != TOPLINK DESIGN`                            |
| SRC-012 | `docs/toplink-v1/PRODUCT.md` and `product/*.md`              | approved P2 product truth    | product/content authority         | page jobs, content and conversion obligations            | ACTIVE IN P3B | approved at remote P2 HEAD `c568ff39...`                         |
...
| SRC-015 | P3A A/B/C comparison and evidence                           | generated comparison         | historical direction evidence     | critique and anti-regression reference                   | REFERENCE     | A/B are no longer active directions                              |
| SRC-016 | Human selection: C — Tân Cung Đương Đại                     | explicit current decision    | design-direction authority        | pure C lock with bounded refinement                      | LOCKED        | A/B require a new user instruction to re-enter                   |
| SRC-017 | `design/DESIGN.md`, tokens/motion/morphology and P3B evidence | generated P3B authority      | implementation design authority   | P4 frontend design and conditional asset insertion       | ACTIVE IN P3B | product meaning remains P2-owned                                 |
