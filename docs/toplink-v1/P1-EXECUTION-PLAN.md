# Phase P1 — Authorized Reference Extraction Execution Plan

> **Execution contract:** one Codex actor, one active route, progressive context loading,
> evidence before abstraction, no application-source mutation, and a hard stop before P2.

**Goal:** Produce a small, traceable design-input corpus from live Sen behavior and the
provisional Toplink brand dossier without copying Sen assets/content or designing Toplink.

**Authority:** Current P1 user prompt, `DECISIONS.md`, `MASTER-PLAN.md`,
`execution/PHASE-1-REFERENCE.md`, authorized-reference policy, and approved P0 SHA
`12be3fe9e99d022c3a11005712244b2877002733`.

## Task 1 — Recover and isolate state

- [x] Fetch origin metadata and verify canonical remote.
- [x] Verify `origin/main` and approved P0 remote SHA.
...
P1 may close only as `COMPLETE — READY FOR HUMAN REVIEW`, with exactly one next action and
without merge, deploy, production change, file deletion, final design lock or P2 work.
