...
| F4 staff/credential/stats | true collapse                                              | `/gioi-thieu` + imports                                         | DOM absence, build/browser                             | pending               | ELIGIBLE                  |
| F5 review/testimonial     | true collapse                                              | `/gioi-thieu` + `ReviewWall` consumer                           | DOM absence, build/browser                             | pending               | ELIGIBLE                  |
| F1 identity/contact       | true collapse shared contact surfaces                      | contact route + global footer/mobile/Zalo + exact CTA consumers | route/task/network/browser                             | pending               | ELIGIBLE AFTER EXACT DIFF |
| F9 article/knowledge      | reviewed-content collapse                                  | index/detail routes                                             | 0 health body claims in DOM, build all static params   | pending               | ELIGIBLE AFTER EXACT DIFF |
| F2 service facts          | no automatic mutation                                      | service data/routes/cards                                       | coverage delta                                         | none                  | DEFERRED                  |
| F3 health claims          | no inference                                               | service/article/about/FAQ owners                                | family-specific omissions only                         | none                  | BLOCKED / DEFERRED        |
